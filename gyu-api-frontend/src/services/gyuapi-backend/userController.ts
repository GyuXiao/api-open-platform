...
/** userLogin POST /gyu_api/v1/user/login */
export async function userLoginUsingPOST(
  body: {username?: string ; password?: string},
  options?: { [p: string]: any },
) {
  return request<API.BaseResponseUser>('/gyu_api/v1/user/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** userLogout POST /gyu_api/v1/user/logout */
export async function userLogoutUsingPOST(options?: { [key: string]: any }) {
    return request<API.BaseResponseboolean>('/gyu_api/v1/user/logout', {
        method: 'POST',
        ...(options || {}),
    });
}
